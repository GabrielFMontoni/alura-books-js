const sectionDosLivros = document.querySelector('#livros')
const sectionDoPrecoTotal = document.querySelector('#valor_total_livros_disponiveis')
function exibirOsLivrosNaTela(listaLivros){
  sectionDoPrecoTotal.innerHTML = ''
  sectionDosLivros.innerHTML = ''
